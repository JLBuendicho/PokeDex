      ...
      <div className="pokedex-container">
        <div className="pokedex-list">
          ...
          <div style={{display: "flex", flexWrap: "wrap", gap: "10px", flexDirection: "column"}}>
            {[
              ...
              <label key={typeOption} style={{ minWidth: "100px", display: "flex", alignItems: "flex-start" }}>
                <input
                  type="checkbox"
                  name="Types"
                  value={typeOption}
                  ...
                  onChange={(event) => {
                    if (event.target.checked) {
                      ...
                      setTypeFilter([
                        ...typeFilter.filter((type) => type !== event.target.value),
                      ]);
                    }
                  }}
                />
        ...
        <div className="pokedex-content">
          ...
          <div className="pokemons">
            {filteredPokemons.map((pokemon) => (
              <Link key={pokemon.id} to={`/edit-pokemon/${pokemon.id}`}>
        ...
        <div className="pokedex-options">
          <RoleProtectedNavButton
            navTo={"/register-pokemon"}
            buttonText="Register Pokemon"
            allowedRoles={["Admin"]}
          />
          <ProtectedNavButton
            navTo="/dashboard"
